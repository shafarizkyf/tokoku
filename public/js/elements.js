...
const ImagePreviewTiny = ({imageUrl, sourceType, index}) => {
  return `
    <div class="image-container">
      <img src="${imageUrl}" class="img-thumbnail tiny">
      <button class="remove-btn" name="btn-remove-img" data-index="${index}" data-source="${sourceType}">
